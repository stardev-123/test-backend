const config = {
  ...
  // serverUrl: 'https://api-dev.onrampinvest.com/',
  website: {
  ...
  mysql: {
    dialect: 'mysql',
    host: 'onramp-dev.cgd23uzxj07q.us-west-2.rds.amazonaws.com',
    database: 'oramp_dev',
    dialectOptions: { decimalNumbers: true, ssl: 'Amazon RDS' },
    username: 'root', // oramp_r00t
    password: '123456', // 1nvest1nreal1ty
    pool: { max: 100, min: 2 }
  },
  logger: {
    path: './log/server.log'
