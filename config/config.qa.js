const config = {
  env: 'QA',
  serverUrl: 'https://api-staging.onrampinvest.com/',
  website: {
  ...
  mysql: {
    dialect: 'mysql',
    host: 'onramp-staging.cgd23uzxj07q.us-west-2.rds.amazonaws.com',
    database: 'onramp_qa',
    dialectOptions: { decimalNumbers: true, ssl: 'Amazon RDS' },
    username: 'oramp_r00t',
    password: '1nvest1nreal1ty',
    pool: { max: 100, min: 2 }
  },
  log: {
    level: 'debug',
  ...
  analytics: 'mixpanel',
  mixpanel: {
    token: 'e6bd68e55ecdccfe1b7b5bbc0d54b790'
  },
  push: {
    common: {
